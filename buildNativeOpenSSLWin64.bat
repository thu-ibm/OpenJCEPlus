...
IF NOT DEFINED OPENSSL_HOME (
	echo "OPENSSL_HOME must be set (path to OpenSSL v3 installation)"
	goto :eof
)
...
@call nmake -nologo -f openssl\jgskit_openssl.win64.cygwin.mak clean
@call nmake -nologo -f openssl\jgskit_openssl.win64.cygwin.mak
