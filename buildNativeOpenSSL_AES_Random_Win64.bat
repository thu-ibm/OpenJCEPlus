...
echo ========================================
echo OpenSSL Native Build - AES and Random Only
echo ========================================
echo.
...
if exist "!VCVARS_SCRIPT!" (
    ...
    echo ========================================
    echo Building OpenSSL native library (AES and Random only)
    echo ========================================
    nmake -nologo -f openssl\openssl_aes_random.win64.mak
    ...
    echo Note: This DLL contains only AES and Random algorithms
    echo.
